...
CREATE TABLE `bus_customer`  (
  ...
  `customername` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '客户姓名',
  `address` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '客户地址',
  `telephone` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '客户公司电话',
  `linkman` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '联系人',
  `phone` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '联系人手机',
  `bank` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '开户银行',
  `account` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '客户银行账号',
  `email` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '联系人邮箱',
  `fax` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '联系人传真',
...
CREATE TABLE `bus_goods`  (
  ...
  `price` double NULL DEFAULT NULL COMMENT '商品售价',
  `number` int(11) NULL DEFAULT NULL COMMENT '商品数量',
  `dangernum` int(11) NULL DEFAULT NULL COMMENT '预警数量',
  `goodsimg` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '商品图片',
  `typeid` int(11) NULL DEFAULT NULL COMMENT '商品分类编号',
  `providerid` int(11) NULL DEFAULT NULL COMMENT '供应商编号',
  PRIMARY KEY (`id`) USING BTREE
...
CREATE TABLE `bus_goods_type`  (
  ...
  `title` varchar(100) CHARACTER SET utf8 COLLATE utf8_bin NULL DEFAULT NULL COMMENT '分类名称',
  `pid` int(11) NULL DEFAULT NULL COMMENT '父类编号',
  `icon` varchar(100) CHARACTER SET utf8 COLLATE utf8_bin NULL DEFAULT NULL COMMENT '分类图标',
  `open` int(11) NULL DEFAULT NULL COMMENT '是否展开（0展开，1不展开）',
...
CREATE TABLE `bus_provider`  (
  ...
  `zip` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '供应商邮编',
  `address` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '供应商地址',
  `telephone` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '供应商公司联系电话',
  `linkman` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '联系人',
  `phone` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '联系人手机',
  `bank` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '开户银行',
  ...
  `fax` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '供应商传真',
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 4 CHARACTER SET = utf8 COLLATE = utf8_general_ci ROW_FORMAT = Dynamic;
...
CREATE TABLE `sys_dept`  (
  ...
  `pid` int(11) NULL DEFAULT NULL COMMENT '父级部门编号',
  `title` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '父级部门名称',
  `open` int(11) NULL DEFAULT NULL COMMENT '是否展开(0-展开,1-不展开)',
...
CREATE TABLE `sys_leavebill`  (
  ...
  `checkPerson` int(11) NULL DEFAULT NULL COMMENT '审批人',
  `committime` datetime(0) NULL DEFAULT NULL COMMENT '请假单提交时间',
  PRIMARY KEY (`id`) USING BTREE
...
CREATE TABLE `sys_log`  (
  ...
  `type` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '日志操作类型',
  `loginname` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '执行人',
  `userid` int(11) NULL DEFAULT NULL COMMENT '执行人编号',
...
INSERT INTO `sys_log` VALUES (37, '用户登录', '登录操作', 'system-超级管理员', 1, '0:0:0:0:0:0:0:1', '2020-01-26 23:47:05');
INSERT INTO `sys_log` VALUES (38, '用户登录', '登录操作', 'system-超级管理员', 1, '0:0:0:0:0:0:0:1', '2020-01-27 00:05:38');
INSERT INTO `sys_log` VALUES (39, '用户登录', '登录操作', 'system-超级管理员', 1, '0:0:0:0:0:0:0:1', '2020-01-27 00:06:46');
INSERT INTO `sys_log` VALUES (40, '用户登录', '登录操作', 'system-超级管理员', 1, '0:0:0:0:0:0:0:1', '2020-01-28 23:42:01');
INSERT INTO `sys_log` VALUES (41, '用户登录', '登录操作', 'system-超级管理员', 1, '0:0:0:0:0:0:0:1', '2020-01-29 00:38:01');
INSERT INTO `sys_log` VALUES (42, '用户登录', '登录操作', 'system-超级管理员', 1, '0:0:0:0:0:0:0:1', '2020-01-29 00:39:14');
INSERT INTO `sys_log` VALUES (43, '用户登录', '登录操作', 'system-超级管理员', 1, '0:0:0:0:0:0:0:1', '2020-01-29 01:12:10');
INSERT INTO `sys_log` VALUES (44, '用户登录', '登录操作', 'system-超级管理员', 1, '0:0:0:0:0:0:0:1', '2020-02-01 17:51:28');
INSERT INTO `sys_log` VALUES (45, '用户登录', '登录操作', 'system-超级管理员', 1, '0:0:0:0:0:0:0:1', '2020-02-01 19:03:41');
INSERT INTO `sys_log` VALUES (46, '用户登录', '登录操作', 'system-超级管理员', 1, '0:0:0:0:0:0:0:1', '2020-02-01 19:14:52');
INSERT INTO `sys_log` VALUES (47, '用户登录', '登录操作', 'system-超级管理员', 1, '0:0:0:0:0:0:0:1', '2020-02-01 19:32:32');
INSERT INTO `sys_log` VALUES (48, '用户登录', '登录操作', 'system-超级管理员', 1, '0:0:0:0:0:0:0:1', '2020-02-01 20:07:02');
INSERT INTO `sys_log` VALUES (49, '用户登录', '登录操作', 'system-超级管理员', 1, '0:0:0:0:0:0:0:1', '2020-02-01 20:12:12');
INSERT INTO `sys_log` VALUES (50, '用户登录', '登录操作', 'system-超级管理员', 1, '0:0:0:0:0:0:0:1', '2020-02-01 20:18:21');
INSERT INTO `sys_log` VALUES (51, '用户登录', '登录操作', 'system-超级管理员', 1, '0:0:0:0:0:0:0:1', '2020-02-02 16:40:38');
INSERT INTO `sys_log` VALUES (52, '用户登录', '登录操作', 'system-超级管理员', 1, '0:0:0:0:0:0:0:1', '2020-02-02 16:59:59');
INSERT INTO `sys_log` VALUES (53, '用户登录', '登录操作', 'system-超级管理员', 1, '0:0:0:0:0:0:0:1', '2020-02-02 17:02:26');
INSERT INTO `sys_log` VALUES (54, '用户登录', '登录操作', 'system-超级管理员', 1, '0:0:0:0:0:0:0:1', '2020-02-02 22:26:51');
INSERT INTO `sys_log` VALUES (55, '用户登录', '登录操作', 'system-超级管理员', 1, '0:0:0:0:0:0:0:1', '2020-02-02 22:34:53');
INSERT INTO `sys_log` VALUES (56, '用户登录', '登录操作', 'system-超级管理员', 1, '0:0:0:0:0:0:0:1', '2020-02-02 23:26:41');
INSERT INTO `sys_log` VALUES (57, '用户登录', '登录操作', 'system-超级管理员', 1, '0:0:0:0:0:0:0:1', '2020-02-02 23:45:02');
INSERT INTO `sys_log` VALUES (58, '用户登录', '登录操作', 'system-超级管理员', 1, '0:0:0:0:0:0:0:1', '2020-02-03 00:08:33');
INSERT INTO `sys_log` VALUES (59, '用户登录', '登录操作', 'system-超级管理员', 1, '0:0:0:0:0:0:0:1', '2020-04-27 16:57:28');
INSERT INTO `sys_log` VALUES (60, '用户登录', '登录操作', 'system-超级管理员', 1, '0:0:0:0:0:0:0:1', '2020-05-02 16:23:02');
INSERT INTO `sys_log` VALUES (61, '用户登录', '登录操作', 'system-超级管理员', 1, '0:0:0:0:0:0:0:1', '2020-05-02 16:35:29');
...
CREATE TABLE `sys_permission`  (
  ...
  `pid` int(11) NULL DEFAULT NULL COMMENT '所属菜单(标识他的父级菜单)',
  `type` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '权限类型[menu/permission]',
  `title` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '菜单权限名称',
  ...
  `href` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '菜单跳转请求路径',
  `open` int(11) NULL DEFAULT NULL COMMENT '菜单是否展开(0展开，1不展开)',
...
CREATE TABLE `sys_user`  (
  ...
  `deptid` int(11) NULL DEFAULT NULL COMMENT '所在部门编号',
  `hiredate` datetime(0) NULL DEFAULT NULL COMMENT '入职日期',
  `mgr` int(11) NULL DEFAULT NULL COMMENT '所属领导',
  ...
  `available` int(11) NULL DEFAULT 1 COMMENT '是否可用(0否1可)',
